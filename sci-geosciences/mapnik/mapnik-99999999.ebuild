...
inherit eutils flag-o-matic python toolchain-funcs versionator git

EGIT_REPO_URI="git://github.com/${PN}/${PN}2.git"
...
src_install() {
	...
	if use python ; then
	    fperms 0755 "$(python_get_sitedir)"/mapnik2/paths.py
